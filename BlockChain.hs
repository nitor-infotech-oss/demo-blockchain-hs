...
replaceBlockChain :: BlockChain -> BlockChain -> (Maybe BlockChain)
replaceBlockChain oldBlockChain newBlockChain
    | (isChainLonger oldBlockChain newBlockChain) && (isValidBlockChain newBlockChain) = Just newBlockChain
    | otherwise = Nothing
